...
`),()=>q.modified.includes(V(t).id),()=>Ki(V(t).offset),()=>Ki(V(t).size),()=>Gi(V(t).size),()=>V(t).compressed?Gi(V(t).disc_size):`–`,()=>_(V(t)).replace(` `,`-`),()=>_(V(t)),()=>q.nameOf(V(t))]),H(`click`,n,()=>q.selected=V(t).id),W(e,n)}),M(ie),M(te);var ae=z(te,2),oe=e=>{var t=cy(),n=L(t),r=R(n);M(t),B(()=>G(r,`Show more (${V(m).length-V(l)} left)`)),H(`click`,n,()=>I(l,V(l)+600)),W(e,t)};K(ae,e=>{V(l)<V(m).length&&e(oe)}),M(k),M(y);var se=z(y,2),ce=e=>{var t=ly();Tv(L(t),{get id(){return q.selected},onclose:()=>q.selected=null}),M(t),W(e,t)};K(se,e=>{q.selected!==null&&e(ce)}),M(v),B(()=>{b=li(y,1,`list svelte-2py9m`,null,b,{narrow:q.selected!==null}),G(ee,`${V(m).length??``} of ${V(u).length??``} files`)}),ki(S,()=>V(a),e=>I(a,e)),gi(C,()=>V(o),e=>I(o,e)),gi(T,()=>V(s),e=>I(s,e)),Ai(O,()=>V(c),e=>I(c,e)),W(e,v),He()}Er([`click`]);var fy=Li(()=>q),py=U(`<button> </button>`),my=U(`<span class="dim">loading…</span>`),hy=U(`<span class="dim" title="Thumbnails are made from your game files after it is selected"> </span>`),gy=U(`<!> <span> </span>`,1),_y=U(`<span class="pill bad svelte-1n46o8q">no game selected</span>`),vy=U(`<div class="card warn" style="margin:16px"> </div>`),yy=U(`<header class="svelte-1n46o8q"><div class="brand svelte-1n46o8q">MSSB Editor</div> <nav class="svelte-1n46o8q"></nav> <div class="status svelte-1n46o8q"><!></div></header> <main class="svelte-1n46o8q"><!></main>`,1);function by(e,t){Ve(t,!1);let n=[{id:`browse`,label:`Browse assets`},{id:`files`,label:`All files`},{id:`music`,label:`Music`},{id:`game`,label:`Game`}];zi(()=>{let e=location.hash.replace(`#`,``);e.startsWith(`entry/`)?(fy(fy().selected=+e.slice(6)),fy(fy().page=`browse`)):n.some(t=>t.id===e)&&fy(fy().page=e),fy().refresh()}),Fi();var r=yy(),i=sn(r),a=z(L(i),2);Yr(a,5,()=>n,Gr,(e,t)=>{var n=py();let r;var i=R(n,!0);B(()=>{r=li(n,1,`svelte-1n46o8q`,null,r,{on:fy().page===V(t).id}),G(i,V(t).label)}),H(`click`,n,()=>fy().go(V(t).id)),W(e,n)}),M(a);var o=z(a,2),s=L(o),c=e=>{W(e,my())},l=e=>{var t=gy(),n=sn(t),r=e=>{var t=hy(),n=R(t);B(()=>G(n,`building thumbnails ${fy().thumbs.done??``}/${fy().thumbs.total??``}…`)),W(e,t)};K(n,e=>{fy().thumbs.running&&e(r)});var i=z(n,2);let a;var o=R(i);B(()=>{a=li(i,1,`pill svelte-1n46o8q`,null,a,{rw:fy().game.writable}),Ti(i,`title`,fy().game.setting??``),G(o,`${fy().game.layout===`iso`?`ISO`:`Extracted folder`} · ${fy().game.writable?`editable`:`view only`}`)}),W(e,t)},u=e=>{W(e,_y())};K(s,e=>{fy().loading?e(c):fy().game?.ok?e(l,1):e(u,-1)}),M(o),M(i);var d=z(i,2),f=L(d),p=e=>{var t=vy(),n=R(t);B(()=>G(n,`Could not reach the editor: ${fy().error??``}`)),W(e,t)},m=e=>{fa(e,{})},h=e=>{zv(e,{})},g=e=>{dy(e,{})},_=e=>{ry(e,{})};K(f,e=>{fy().error?e(p):fy().page===`game`?e(m,1):fy().page===`browse`?e(h,2):fy().page===`files`?e(g,3):fy().page===`music`&&e(_,4)}),M(d),W(e,r),He()}Er([`click`]),Br(by,{target:document.getElementById(`app`)});